...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans selection:bg-brass-gold selection:text-ink-navy bg-ivory-paper">
      ...
      <section 
        id="hero" 
        className="relative py-16 md:py-24 overflow-hidden px-4 sm:px-6 lg:px-8 w-full min-h-[60vh] flex items-center bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/assets/school-building-2.jpeg?v=2')" }}
      >
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="max-w-3xl flex flex-col space-y-5">
            ...
            <p className="text-gray-200 text-sm md:text-base leading-relaxed max-w-2xl font-sans drop-shadow-sm">
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <a 
                href="#about"
                className="bg-brass-gold text-ink-navy hover:bg-brass-gold/90 px-5 py-2.5 rounded-sm font-sans font-bold text-xs md:text-sm tracking-wide shadow-md transition-all duration-200 hover:translate-y-[-1px] active:translate-y-0"
              >
                Explore the School
              </a>
              <a 
                href="#contact"
                className="border-2 border-white text-white hover:bg-white hover:text-ink-navy px-5 py-2 rounded-sm font-sans font-medium text-xs md:text-sm tracking-wide transition-all duration-200 hover:translate-y-[-1px] active:translate-y-0"
              >
                Admission 2026–27
              </a>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-5 border-t border-white/15 max-w-md">
              <div>
        ...
        {isMediaModalOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="bg-ivory-paper border-2 border-brass-gold/25 max-w-7xl w-full rounded-md shadow-2xl relative z-10 max-h-[85vh] overflow-hidden flex flex-col"
            >
              {/* Modal Header */}
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 mb-8">
                  {[
                    ...
                    <button
                      ...
                      className={`px-3.5 py-1.5 font-mono text-[10px] font-bold uppercase tracking-wider rounded-full border transition-all cursor-pointer ${
